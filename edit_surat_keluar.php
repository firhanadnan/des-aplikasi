 ...
 <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Edit Surat Keluar</h3>
            <ol class="breadcrumb">
                ...
                <h4 class="card-title">Input Surat Keluar</h4>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input id="no_agenda" type="number" class="form-control form-control-line" value="<?= $no_agenda?>" name="no_agenda" required>
                                <?php
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input id="tujuan" type="text" class="form-control form-control-line" name="tujuan" value="<?= $tujuan;?>" required>
                                <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input id="mdate" type="text" name="tgl_surat" class="form-control form-control-line" value="<?= $tgl_surat;?>" required>
                                <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input id="no_surat" type="text" class="form-control form-control-line" name="no_surat" value="<?= $no_surat;?>" required>
                                <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input  type="text" class="form-control form-control-line" name="keterangan" value="<?= $keterangan;?>" required>
                                <?php
                ...
                <div class="row">  
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <textarea id="isi" class="materialize-textarea form-control form-control-line" name="isi" required><?= $isi;?></textarea>
                                <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="file" id="file" name="file" value="<?= $file;?>" class="form-control form-control-line" >
                                        <?php
