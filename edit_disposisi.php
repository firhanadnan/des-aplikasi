                ...
                <h4 class="card-title">Edit Disposisi</h4>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="control-label text-right col-md-3">Disposisi</label>
                            <div class="col-md-9">
                                <input type="hidden" value="<?php echo $row['id_disposisi'] ;?>">
                                <input id="tujuan" type="text" class="form-control form-control-line" name="tujuan" value="<?php echo $row['tujuan'] ;?>" required>
                                    <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="mdate" class="form-control form-control-line" type="text" name="batas_waktu" value="<?php echo $row['batas_waktu']; ?>"required>
                                    <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea id="isi_disposisi" class="form-control form-control-line" name="isi_disposisi" required><?php echo $row['isi_disposisi'] ;?></textarea>
                                    <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="catatan" type="text" class="form-control form-control-line" name="catatan" value="<?php echo $row['catatan'] ;?>" required>
                                    <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control form-control-line" name="sifat" id="sifat" required>
                                    <option value="<?= $row['sifat'];?>"><?= $row['sifat'];?></option>
                        ...
                        <div  style="margin-left: 40px;">
                            ...
                            <a href="?page=tsm&act=disp&id_surat=<?php echo $row['id_surat']; ?>" class="btn btn-inverse">Cancel</a>
                        </div>
