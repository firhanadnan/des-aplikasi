                ...
                <div class="noprint">    
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            <h3 class="text-themecolor m-b-0 m-t-0">Agenda Surat Keluar</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Agenda Surat Keluar</li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <h5 class="hid" style="text-align:center; margin-bottom:20px;"><strong>AGENDA SURAT KELUAR</strong></h5>';
                            ...
                            <h4 style="margin-left: 40px; text-align:center;">Agenda Surat Keluar dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong> <button style="margin-left: 42px;" type="submit" onClick="window.print()" class="btn btn-large btn-warning">CETAK AGENDA</button></h4>
