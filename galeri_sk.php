                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row agenda">
                                <div class="col s12">';
                                    ...
                                    <h2 class="warna agenda">Galeri file surat keluar antara tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></h2>
                                </div>
                            </div>';
                        ...
                        if(mysqli_num_rows($query) > 0){
                            ...
                            while($row = mysqli_fetch_array($query)){
                                ...
                                if(empty($row['file'])){
                                    ...
                                    echo '
                                        <div class="col-md-1">
                                            <img style="width:70px; margin-bottom:5px;" data-caption="'.date('d M Y', strtotime($row['tgl_catat'])).'" src="./upload/surat_keluar/'.$row['file'].'"/>
                                            <a class="btn btn-info"  style="margin-right:5px;" href="?page=gsk&act=fsk&id_surat='.$row['id_surat'].'">Detail</a>
                                        </div>';
                                    } else {
                                        ...
                                        echo '
                                            <div class="col-md-1">
                                                <img style="width:50px; margin-bottom:5px;" data-caption="'.date('d M Y', strtotime($row['tgl_catat'])).'" src="./assets/images/word.png"/>
                                                <a class="btn btn-info" style="margin-right:5px;" href="?page=gsk&act=fsk&id_surat='.$row['id_surat'].'">Detail</a>
                                            </div>';
                                        } else {
                                            echo '
                                                <div class="col-md-1">
                                                    <img style="width:50px; margin-bottom:5px;" data-caption="'.date('d M Y', strtotime($row['tgl_catat'])).'" src="./assets/images/pdf.png"/>
                                                    <a class="btn btn-info" style="margin-right:5px; href="?page=gsk&act=fsk&id_surat='.$row['id_surat'].'">Detail</a>
                                                </div>';
                                        }
                                    }
