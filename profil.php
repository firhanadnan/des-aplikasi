                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="username" type="text" class="form-control form-control-line" name="username" value="<?php echo $_SESSION['username']; ?>" required>
                                    <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="nama" type="text" class="form-control form-control-line" name="nama" value="<?php echo $_SESSION['nama']; ?>" required>
                                    <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="password_lama" type="password" class="form-control form-control-line" name="password_lama" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="nip" type="text" class="form-control form-control-line" name="nip" value="<?php echo $_SESSION['nip']; ?>" required autocomplete="off">
                                    <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="password" type="password" class="form-control form-control-line" name="password" required>
                                    ...
                                    ?>
                                <small class="text-danger">*Setelah menekan tombol "Simpan", Anda akan diminta melakukan Login ulang.</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div  style="margin-left: 40px;">
                        ...
                        <a href="admin.php" class="btn btn-inverse">Cancel</a>
                    </div>
