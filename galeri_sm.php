                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            <h3 class="text-themecolor m-b-0 m-t-0">Galeri Surat Masuk</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Galeri Surat Masuk</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row ">
                                ...
                                <h2 class="warna agenda"><center>Galeri file surat masuk antara tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></center></h3>
                                </div>
                            </div>';
                        ...
                        if(mysqli_num_rows($query) > 0){
                            ...
                            while($row = mysqli_fetch_array($query)){
                                ...
                                if(empty($row['file'])){
                                    ...
                                    echo '
                                        <div class="col-md-1">
                                            <img style="width:50px;" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./upload/surat_masuk/'.$row['file'].'"/>
                                            <a class="btn btn-info" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Tampilkan Ukuran Penuh</a>
                                        </div>';
                                    } else {
                                        ...
                                        echo '
                                            <div class="col-md-1">
                                                <img style="width:50px;" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src=".assets/images/word.png"/>
                                                <a class="btn btn-info" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Detail</a>
                                            </div>';
                                        } else {
                                            echo '
                                                <div class="col-md-1">
                                                    <img style="width:50px; margin-bottom:5px;" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./assets/images/pdf.png"/><br>
                                                    <a class="btn btn-info" style="margin-right:5px;" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Detail</a>
                                                </div>';
